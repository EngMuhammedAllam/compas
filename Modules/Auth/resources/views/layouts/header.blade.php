<style>
    ...
    @media (max-width: 992px) {
        ...
        .shiraa-actions {
            display: flex;
            gap: 0.25rem;
            margin-right: auto; /* Pushes everything to the left, next to the menu */
            margin-left: 0.5rem;
        }
        ...
        .shiraa-icon-btn:hover, .shiraa-icon-btn:active {
            background: rgba(0, 0, 0, 0.05) !important;
            border-radius: 50%;
        }

        .eh .shiraa-icon-btn:hover, .eh .shiraa-icon-btn:active {
        ...
        .shiraa-nav__link.active, .shiraa-nav__link:hover {
            color: #0284c7;
        }
    }
</style>
...
<div class="shiraa-header-wrapper" :class="{ 'scrolled' : stickyMenu }"
    ...
    <div class="shiraa-topbar">
        <div class="shiraa-topbar__side">
            <span class="shiraa-topbar__item">
                ...
                123 Laravel St, Web City, Webland
            </span>
            <span class="shiraa-topbar__item">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <header class="shiraa-navbar">
        <div class="shiraa-navbar__inner">
            ...
            <nav class="shiraa-nav">
                <ul>
                    <li><a href="{{ route('landing') }}" class="{{ $page == 'home' ? 'active' : '' }}">الرئيسية</a></li>
            ...
            <!-- Actions (Circular Icons exactly like SHIRAA) -->
            <div class="shiraa-actions">
                <!-- Theme Toggle Icon -->
                <button class="shiraa-icon-btn" @click="darkMode = !darkMode" aria-label="تبديل الوضع">
                    <svg x-show="!darkMode" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path>
                    </svg>
                    <svg x-show="darkMode" x-cloak xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <!-- Search Icon (Placeholder to match SHIRAA) -->
                <button class="shiraa-icon-btn" aria-label="بحث">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <!-- Mobile Toggle -->
            <button class="shiraa-mobile-toggle" @click="navigationOpen = !navigationOpen">
                <svg x-show="!navigationOpen" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <line x1="3" y1="12" x2="21" y2="12"></line>
                    <line x1="3" y1="6" x2="21" y2="6"></line>
                    <line x1="3" y1="18" x2="21" y2="18"></line>
                </svg>
                <svg x-show="navigationOpen" x-cloak xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <div class="shiraa-mobile-menu" :class="{ 'active' : navigationOpen }">
        <a href="{{ route('landing') }}" class="shiraa-nav__link {{ $page == 'home' ? 'active' : '' }}">الرئيسية</a>
