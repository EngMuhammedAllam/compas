    ...
    <section class="premium-hero">
        ...
        <div class="premium-hero__container">
            ...
            <div class="premium-hero__content animate_right">
                ...
                <p class="premium-hero__desc">
                    {{ $heroSection->description }}
                </p>

                <div class="premium-hero__metrics" aria-label="مؤشرات الثقة">
                    <div class="premium-hero__metric">
                        <strong>15+</strong>
                        <span>سنة خبرة في حلول التبريد الصناعي والمركزي</span>
                    </div>
                    <div class="premium-hero__metric">
                        <strong>24/7</strong>
                        <span>دعم فني واستجابة سريعة للأعطال الحرجة</span>
                    </div>
                    <div class="premium-hero__metric">
                        <strong>40%</strong>
                        <span>تحسينات ممكنة في استهلاك الطاقة حسب النظام</span>
                    </div>
                </div>
