        ...
        <div class="tc uf ap gg fp">
          <div class="animate_top zd/2 to/4">
            <a href="{{ route('landing') }}">
              <img class="om" src="{{ secure_asset('land/images/logo-light-opt.png')}}" alt="Logo Light" style="width: 75px;" />
              <img class="xc nm" src="{{ secure_asset('land/images/logo-dark-opt.png')}}" alt="Logo Dark" style="width: 75px;" />
            </a>
            ...
            <ul class="tc wf cg" aria-label="روابط تواصل اجتماعي">
              <li>
                <a href="https://www.facebook.com/" target="_blank" rel="noopener" aria-label="تابِعنا على فيسبوك">
                  <!-- Facebook SVG -->
              ...
              <li>
                <a href="https://twitter.com/" target="_blank" rel="noopener" aria-label="تابِعنا على تويتر">
                  <!-- Twitter SVG -->
                  <svg class="vh ul cl il" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
              ...
              <li>
                <a href="https://www.linkedin.com/" target="_blank" rel="noopener" aria-label="تابِعنا على لينكد إن">
                  <!-- LinkedIn SVG -->
                  <svg class="vh ul cl il" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
              ...
              <li>
                <a href="https://www.instagram.com/" target="_blank" rel="noopener" aria-label="تابِعنا على إنستجرام">
                  <!-- Instagram SVG -->
