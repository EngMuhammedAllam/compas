        ...
        <div class="tc uf ap gg fp">
          <div class="animate_top zd/2 to/4">
            ...
            <ul class="tc wf cg" aria-label="روابط تواصل اجتماعي">
              <li>
                <a href="https://www.facebook.com/" target="_blank" rel="noopener" aria-label="فيسبوك">
                  <!-- Facebook SVG -->
              ...
              <li>
                <a href="https://twitter.com/" target="_blank" rel="noopener" aria-label="تويتر">
                  <!-- Twitter SVG -->
                  <svg class="vh ul cl il" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
              ...
              <li>
                <a href="https://www.instagram.com/" target="_blank" rel="noopener" aria-label="إنستجرام">
                  <!-- Instagram SVG -->
