  <header class="g s r vd ya cj" :class="{ 'hh sm _k dj bl ll' : stickyMenu }" dir="ltr"
      ...
      <div class="vd wo/4 sd qo f ho oo wf yf" :class="{ 'd hh rm sr td ud qg ug jc yh': navigationOpen }">
        <nav>
          <ul class="tc _o sf yo cg ep">
            <li><a href="#contact" class="xl">اتصل بنا</a></li>
            <li><a href="#news" class="xl">أحدث المقالات</a></li>
            <li><a href="#projects" class="xl">المشاريع</a></li>
            <li class="c i" x-data="{ dropdown: false }">
              <a href="#about" class="xl tc wf yf bg"
