...
<head>
    ...
    <meta name="dir" dir="rtl" />
    <meta http-equiv="Copyright" content="Mas" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta name="author" content="Ranyeh" />
    <meta name="rating" content="general" />
    <meta name="language" content="Arabic" />
    <meta name="application-name" content="Mass" />
    <meta name="description" content="Tailwind CSS Company Landing Page Template by Ranyeh." />
    <meta name="keywords" content="company" />
    <meta name="twitter:title" content="Mass | Tailwind CSS Company Landing Page" />
    <meta name="twitter:description" content="Tailwind CSS Company Landing Page Template by Ranyeh." />
    <meta name="twitter:image" content="./assets/img/Mass-cover.png" />
    <meta content="Mass | Tailwind CSS Company Landing Page" property="og:title" />
    <meta content="Mass" property="og:site_name"/>
    <meta content="Tailwind CSS Company Landing Page Template by Ranyeh." property="og:description" />
    <meta content="./assets/img/Mass-cover.png" property="og:image" />
    <meta content="https://ranyeh24.github.io/Mass-tailwind" property="og:url" />
    <meta content="website" property="og:type" />

    <meta name="msapplication-TileColor" content="#674bdf" />
...
<!-- Navbar --> 
<header
    class="ic-navbar absolute left-0 top-0 z-40 flex w-full items-center bg-transparent text-dir"
    role="banner"
        ...
        <div
            ...
            <div class="w-60 lg:w-56 max-w-full px-5">
                <a
                    ...
                    aria-label="الذهاب إلى الصفحة الرئيسية — حلول التبريد والتكييف">
                    <svg
                        ...
                        <title id="brandTitle">حلول التبريد والتكييف</title>
                        <desc id="brandDesc">شعار شركة حلول التبريد والتكييف — جودة ومصداقية</desc>
                        <!-- (احتفظ بالمسارات كما هي أو استبدل بشعارك) -->
                        ...
                        <!-- بقية الـ SVG كما في الملف الأصلي -->
                        <polygon points="226.39 62.27 232.8 68.67 282.23 118.11 163.48 89.2 196.84 55.84 190.43 49.44 140.99 0 259.75 28.91 226.39 62.27" id="NavbarBrandIcon" />
                    </svg>
                </a>
            </div>
            <div class="flex w-full items-center justify-between px-5">
                        ...
                        <ul
                            ...
                            <li class="group relative">
                                <a
                                    ...
                                    class="ic-page-scroll mx-8 flex py-2 text-base font-medium text-body-light-12 group-hover:text-primary dark:text-body-dark-12 lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 lg:text-primary-color lg:dark:text-primary-color lg:group-hover:text-primary-color lg:group-hover:opacity-70"
                                    role="menuitem"
                                    aria-label="مشاريعنا">مشاريعنا</a>
                            </li>
                            ...
                            <li class="group relative">
                                <a
                                    ...
                                    class="ic-page-scroll mx-8 flex py-2 text-base font-medium text-body-light-12 group-hover:text-primary dark:text-body-dark-12 lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 lg:text-primary-color lg:dark:text-primary-color lg:group-hover:text-primary-color lg:group-hover:opacity-70"
                                    role="menuitem"
                                    aria-label="العروض والأسعار">العروض والأسعار</a>
                            </li>
                            ...
                            <li class="group relative">
                                <a
                                    ...
                                    class="ic-page-scroll mx-8 flex py-2 text-base font-medium text-body-light-12 group-hover:text-primary dark:text-body-dark-12 lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 lg:text-primary-color lg:dark:text-primary-color lg:group-hover:text-primary-color lg:group-hover:opacity-70"
                                    role="menuitem"
                                    aria-label="فريق العمل">فريق العمل</a>
                            </li>
                            ...
                            <li class="group relative">
                                <a
                                    ...
                                    class="ic-page-scroll mx-8 flex py-2 text-base font-medium text-body-light-12 group-hover:text-primary dark:text-body-dark-12 lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 lg:text-primary-color lg:dark:text-primary-color lg:group-hover:text-primary-color lg:group-hover:opacity-70"
                                    role="menuitem"
                                    aria-label="تواصل معنا">تواصل معنا</a>
                            </li>
                        </ul>
                    </nav>
                </div>
                <div class="flex items-center justify-end pr-[52px] lg:pr-0">
                    <button
                        ...
                        data-web-trigger="web-theme">تبديل الثيم</button>
                </div>
            </div>
        </div>
    </div>
...
<main class="main relative">
    <!-- Hero section -->
    <section style = "background-image: url('./assets/img/main_3.jpeg'); background-size: cover; background-position: center;"  
        id="home"
        class="relative overflow-hidden bg-primary text-primary-color pt-[120px] md:pt-[130px] lg:pt-[160px] text-dir pb-20" 
                ...
                <div class="w-full px-5">
                    <div class="scroll-revealed mx-auto max-w-[780px] text-center">
                        <h1
                            ...
                            حلول متكاملة لغرف التبريد والتكييف — موثوقة وفعّالة لعملك
                        </h1>

                        <p
                            class="mx-auto mb-4 max-w-[600px] text-base text-primary-color sm:text-lg sm:leading-normal">
                            نصمم وننفّذ غرف تبريد وتكييف حسب احتياجاتك الصناعية والتجارية مع تركيز على ثبات
                            المناخ، كفاءة الطاقة، وسهولة الصيانة. من التخطيط إلى التشغيل المستمر — نضمن أداءً موثوقاً
                            يحافظ على جودة منتجاتك ويخفض تكاليف التشغيل.
                        </p>

                        <p class="mx-auto mb-9 max-w-[600px] text-sm text-primary-color/[0.9]">
                            خدماتنا: تصميم هندسي · تركيب متقدم · حلول تبريد صناعي · دعم وصيانة دورية
                        </p>
                        ...
                        <ul
                            ...
                            <li>
                                <a
                                    ...
                                    role="button" aria-label="اطلب استشارة مجانية">اطلب استشارة مجانية</a>
                            </li>
                            ...
                            <li>
                                <a
                                    ...
                                    role="button" aria-label="شاهد الفيديو التعريفي"><i class="lni lni-play text-lg/none"></i> شاهد الفيديو التعريفي</a>
                            </li>
                        </ul>

                        <!-- optional quick-trust badges -->
                        <div class="flex items-center justify-center gap-6 text-sm text-primary-color/[0.8]">
                            <span>تصميم هندسي معتمد</span>
                            <span>•</span>
                            <span>ضمان أداء ومتابعة</span>
                            <span>•</span>
        ...
        <!-- قسم من نحن -->
        <section id="about" class="section-area" dir="rtl">
        <div class="container">
            ...
            <div class="w-full text-right">
                ...
                <h2 class="mb-6 text-3xl font-bold">
                    خبرة وكفاءة في عالم التبريد والتكييف الصناعي
                </h2>
                <p class="text-gray-700 mb-4 leading-relaxed">
                    نحن شركة متخصصة في تصميم وتنفيذ وصيانة غرف التبريد والتجميد وأنظمة التكييف الصناعي والتجاري. 
                    نعمل بخبرة تمتد لسنوات طويلة في هذا المجال، لنقدم حلول تبريد مبتكرة تضمن الأداء العالي وكفاءة الطاقة.
                </p>
                </div>
                ...
                <!-- أزرار التبويب -->
                <nav
                    class="tabs-nav flex flex-wrap gap-4 my-8 justify-end"
                    role="tablist"
                    aria-label="عن الشركة"
                >
                    <button
                    type="button"
                    ...
                    class="tabs-link inline-block py-2 px-4 rounded-md text-body-light-12 dark:text-body-dark-12 bg-body-light-12/10 dark:bg-body-dark-12/10 text-inherit font-medium hover:bg-primary hover:text-primary-color focus:bg-primary focus:text-primary-color"
                    data-web-toggle="tabs"
                    data-web-target="tabs-panel-mission"
                    id="tabs-list-mission"
                    role="tab"
                    aria-controls="tabs-panel-mission"
                    >
                    رسالتنا
                    </button>
                </nav>
                ...
                >
                    ...
                    منذ تأسيسنا، حرصنا على أن نكون في طليعة الشركات المتخصصة في أنظمة التبريد والتكييف الصناعي.
                    بدأنا بخدمات بسيطة ثم توسعنا لنغطي مشاريع ضخمة تشمل مصانع، مستودعات، ومراكز طبية وتجارية.
                    </p>
                    <p class="text-gray-700 leading-relaxed">
                    بفضل التزامنا بالجودة والدقة، اكتسبنا ثقة عملائنا وأصبحنا شريكاً أساسياً في العديد من المشاريع الحيوية.
                    </p>
                </div>
                ...
                >
                    <p class="text-gray-700 mb-3 leading-relaxed">
                    رؤيتنا هي أن نكون الخيار الأول في المنطقة العربية في مجال حلول التبريد والتكييف المتكاملة،
                    من خلال تقديم خدمات تعتمد على التكنولوجيا الحديثة والاستدامة البيئية.
                    </p>
                    <p class="text-gray-700 leading-relaxed">
                    نهدف إلى تطوير حلول أكثر كفاءة وذكاءً تساعد في تقليل استهلاك الطاقة 
                    وتعزيز موثوقية أنظمة التبريد للمؤسسات والمصانع.
                    </p>
                </div>
                ...
                <div
                    class="tabs-content mt-4"
                    id="tabs-panel-mission"
                    tabindex="-1"
                    role="tabpanel"
                    aria-labelledby="tabs-list-mission"
                >
                    <p class="text-gray-700 mb-3 leading-relaxed">
                    رسالتنا هي توفير بيئات تبريد مثالية تحافظ على جودة المنتجات 
                    وتضمن التشغيل المستمر والفعال باستخدام أحدث أنظمة التحكم الذكية.
                    </p>
                    <p class="text-gray-700 leading-relaxed">
                    نؤمن أن نجاحنا يقاس برضا عملائنا، لذلك نحرص على تقديم خدماتنا بأعلى معايير الدقة 
                    والالتزام بالمواعيد والجودة في كل مشروع ننفذه.
                    </p>
                </div>
                </div>
            </div>
        ...
        <!-- قسم الخدمات -->
        <section id="services" class="section-area" style="padding: 40px;">
        <div class="container" dir="rtl">
            <div class="scroll-revealed text-center max-w-[650px] mx-auto mb-12">
            <h6 class="mb-2 block text-lg font-semibold text-primary">
                خدماتنا
            </h6>
            <h2 class="mb-6">حلول متكاملة في مجال التبريد والتكييف</h2>
            <p>
                نقدم في شركتنا حلولاً مبتكرة في مجال غرف التبريد والتكييف الصناعي والتجاري، 
                بداية من التصميم وحتى التنفيذ والصيانة، مع ضمان أعلى معايير الكفاءة والجودة لتلبية احتياجات عملائنا في مختلف القطاعات.
            </p>
            </div>
            ...
            <div class="scroll-revealed col-12 sm:col-6 lg:col-4">
                ...
                <div
                    ...
                    <i class="lni lni-snowflake"></i>
                </div>
                <div class="w-full">
                    <h4 class="text-[1.25rem]/tight font-semibold mb-5">
                    تصميم وتنفيذ غرف التبريد والتجميد
                    </h4>
                    <p>
                    نقوم بتصميم وتنفيذ غرف تبريد وتجميد بمواصفات دقيقة تناسب مختلف الاستخدامات، 
                    سواء للمواد الغذائية أو الدوائية أو الصناعية، مع تحقيق أعلى كفاءة في استهلاك الطاقة.
                    </p>
                </div>
                </div>
            </div>
            ...
            <div class="scroll-revealed col-12 sm:col-6 lg:col-4">
                ...
                <div class="w-full">
                    <h4 class="text-[1.25rem]/tight font-semibold mb-5">
                    أنظمة تكييف الهواء المركزي
                    </h4>
                    <p>
                    نقدم حلول تكييف مركزي متكاملة للمباني التجارية والمستشفيات والمصانع، 
                    باستخدام أحدث التقنيات لضمان توزيع مثالي للهواء وراحة حرارية عالية.
                    </p>
                </div>
                </div>
            </div>
            ...
            <div class="scroll-revealed col-12 sm:col-6 lg:col-4">
                ...
                <div class="w-full">
                    <h4 class="text-[1.25rem]/tight font-semibold mb-5">
                    صيانة وإصلاح أنظمة التبريد
                    </h4>
                    <p>
                    نقدم خدمات صيانة دورية وطارئة لغرف التبريد ووحدات التكييف، 
                    لضمان استمرارية التشغيل وكفاءة الأداء دون توقف مفاجئ.
                    </p>
                </div>
                </div>
            </div>
            ...
            <div class="scroll-revealed col-12 sm:col-6 lg:col-4">
                ...
                <div
                    class="w-[70px] h-[70px] rounded-2xl mb-6 flex items-center justify-center text-[37px]/none bg-primary text-primary-color">
                    <i class="lni lni-temperature"></i>
                </div>
                <div class="w-full">
                    <h4 class="text-[1.25rem]/tight font-semibold mb-5">
                    أنظمة مراقبة وتحكم في درجة الحرارة
                    </h4>
                    <p>
                    نوفر أنظمة ذكية لمراقبة درجات الحرارة والرطوبة داخل الغرف لحظة بلحظة، 
                    مع إمكانية التنبيه عند أي خلل لضمان سلامة المنتجات.
                    </p>
                </div>
                </div>
            </div>
            ...
            <div class="scroll-revealed col-12 sm:col-6 lg:col-4">
                ...
                <div class="w-full">
                    ...
                    <p>
                    نستخدم مواد عزل حراري متقدمة لضمان الحفاظ على درجات الحرارة الداخلية 
                    وتقليل استهلاك الطاقة، مع توفير عزل صوتي للمرافق الحساسة.
                    </p>
                </div>
                </div>
            </div>
            ...
            <div class="scroll-revealed col-12 sm:col-6 lg:col-4">
                ...
                <div class="w-full">
                    <h4 class="text-[1.25rem]/tight font-semibold mb-5">
                    التوريد والتركيب السريع
                    </h4>
                    <p>
                    نوفّر جميع المعدات والمكونات الخاصة بأنظمة التبريد والتكييف من 
                    أفضل العلامات التجارية، مع تركيب احترافي وسريع وفق الجدول الزمني المحدد.
                    </p>
                </div>
                </div>
            </div>
        ...
        <section id="intro" class="section-area">
            <div class="container">
                <div class="scroll-revealed text-center max-w-[550px] mx-auto mb-12">
                    ...
                    <h2 class="mb-6">شاهد كيف نصنع بيئة التبريد المثالية</h2>
                    <p>
                        تعرف على خدماتنا وحلولنا المبتكرة في مجال التبريد والتكييف الصناعي.
                        في هذا الفيديو نأخذك في جولة سريعة داخل مشاريعنا ونوضح كيف نصمم
                        وننفذ غرف التبريد والتجميد بأعلى معايير الجودة والكفاءة لتلبية احتياجات عملائنا.
                    </p>
                </div>
        ...
        <section id="portfolio" class="section-area" dir="rtl">
        <div class="container">
            <div class="scroll-revealed text-center max-w-[550px] mx-auto mb-12">
            <h6 class="mb-2 block text-lg font-semibold text-primary">
                معرض الأعمال
            </h6>
            <h2 class="mb-6">أحدث مشاريعنا في مجال التبريد والتكييف</h2>
            <p>
                نفخر بتنفيذ مجموعة من المشاريع المتميزة في تصميم وتنفيذ غرف التبريد والتجميد
                والمستودعات المبردة باستخدام أحدث التقنيات لضمان كفاءة الطاقة والجودة العالية.
            </p>
            </div>

            <nav
            class="scroll-revealed portfolio-menu mb-[3.750rem] text-center"
            aria-label="فلترة المشاريع">
            <button
                type="button"
            ...
            <div class="portfolio col-12 sm:col-6 lg:col-4">
                ...
                <div class="relative overflow-hidden w-full aspect-[4/3] rounded-xl">
                    ...
                    <div class="flex flex-wrap gap-2 p-4">
                        ...
                        class="portfolio-box text-[1.75rem] text-primary-color bg-primary z-10 w-[60px] aspect-square rounded-lg text-center inline-flex items-center justify-center hover:bg-primary-light-10">
                        <i class="lni lni-zoom-in"></i>
                        </a>
                        <a
                        href="javascript:void(0)"
                        class="text-[1.75rem] text-primary-color bg-primary z-10 w-[60px] aspect-square rounded-lg inline-flex items-center justify-center hover:bg-primary-light-10">
                ...
                <div class="pt-4 text-right">
                    <h4 class="mb-2 text-[1.5rem] font-bold">غرف تبريد المواد الغذائية</h4>
                    <p>
                    تنفيذ غرفة تبريد متكاملة لحفظ المنتجات الغذائية بدرجة حرارة ثابتة مع أنظمة تحكم رقمية عالية الدقة.
                    </p>
                </div>
                </article>
            </div>
            ...
            <div class="portfolio col-12 sm:col-6 lg:col-4">
                ...
                <div class="relative overflow-hidden w-full aspect-[4/3] rounded-xl">
                    ...
                    <div class="flex flex-wrap gap-2 p-4">
                        ...
                        class="portfolio-box text-[1.75rem] text-primary-color bg-primary z-10 w-[60px] aspect-square rounded-lg inline-flex items-center justify-center hover:bg-primary-light-10">
                        <i class="lni lni-zoom-in"></i>
                        </a>
                        <a
                        href="javascript:void(0)"
                ...
                <div class="pt-4 text-right">
                    <h4 class="mb-2 text-[1.5rem] font-bold">غرفة تجميد سريعة</h4>
                    <p>
                    تصميم وتنفيذ غرفة تجميد لحفظ المنتجات سريعة التلف باستخدام عوازل حرارية حديثة وأنظمة تبريد قوية.
                    </p>
                </div>
                </article>
            </div>
            ...
            <div class="portfolio col-12 sm:col-6 lg:col-4">
                ...
                <div class="pt-4 text-right">
                    <h4 class="mb-2 text-[1.5rem] font-bold">تركيب نظام تكييف مركزي</h4>
                    <p>
                    مشروع متكامل لتوريد وتركيب نظام تكييف مركزي لمصنع إنتاج،
                    باستخدام وحدات تبريد موفرة للطاقة.
                    </p>
                </div>
                </article>
            </div>
            ...
            <div class="flex flex-wrap">
                ...
                <div class="w-full md:w-1/2">
                    <div class="my-1 flex justify-center md:justify-end">
                        <p class="text-body-dark-11">
                            &#169; 2024 Mass Inc. All rights reserved. Distributed by <a href="https://themewagon.com" target="_blank">ThemeWagon</a>
                        </p>
                    </div>
                </div>
            </div>
