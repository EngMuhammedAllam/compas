    ...
    <div class="container-fluid">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <div>
                ...
                <span class="fs-semibold text-muted">أضف خدمة جديدة إلى قسم خدمات التبريد والتكييف</span>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('services.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="title" class="form-control" value="{{ old('title') }}" required dir="rtl" placeholder="مثال: الصيانة الدورية">
                            </div>

                            <div class="mb-3">
                                <label class="form-label">وصف الخدمة <sup class="text-danger">*</sup></label>
                                <textarea name="description" class="form-control" rows="4" required dir="rtl" placeholder="اشرح الخدمة بشكل مختصر">{{ old('description') }}</textarea>
                            </div>

                            <div class="mb-3">
                                <label class="form-label">الأيقونة <sup class="text-danger">*</sup></label>
                                <input type="file" name="icon" class="form-control" required dir="rtl" >
                            </div>

                            <div class="mb-3">
                                <label class="form-label">ترتيب العرض</label>
                                <input type="number" name="sort_order" class="form-control" value="{{ old('sort_order', 0) }}" min="0" dir="ltr" placeholder="0">
                            ...
                            <div class="d-flex gap-2">
                                <button type="submit" class="btn btn-primary">
                                    <i class="ri-add-line me-1"></i> إضافة الخدمة
                                </button>
