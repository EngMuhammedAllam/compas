...
<div class="main-content app-content">
    <div class="container-fluid">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <div>
                <h1 class="page-title fw-semibold fs-18 mb-0">إضافة تقييم جديد</h1>
            </div>
            ...
            <div class="col-xl-12">
                <div class="card custom-card">
                    <div class="card-header">
                        <div class="card-title">بيانات التقييم</div>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('testimonials.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label class="form-label">اسم العميل <sup class="text-danger">*</sup>
                                @error('name')
                            ...
                            <div class="mb-3">
                                <label class="form-label">الوظيفة / الشركة
                                @error('position')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                                </label>
                            ...
                            <div class="mb-3">
                                <label class="form-label">التقييم / الاقتباس <sup class="text-danger">*</sup>
                                @error('message')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                                </label>
                            ...
                            <div class="d-flex gap-2">
                                <button type="submit" class="btn btn-primary">
                                    <i class="ri-add-line me-1"></i> إضافة التقييم
                                </button>
