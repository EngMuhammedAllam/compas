...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="{{ secure_asset('dash/assets/images/brand-logos/favicon.ico')}}" type="image/x-icon">
    
    <!-- Choices JS -->
    <script src="{{ secure_asset('dash/assets/libs/choices.js/public/assets/scripts/choices.min.js')}}"></script>

    <!-- Main Theme Js -->
    <script src="{{ secure_asset('dash/assets/js/main.js')}}"></script>
    
    <!-- Bootstrap Css -->
    <link id="style" href="{{ secure_asset('dash/assets/libs/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet" >

    <!-- Style Css -->
    <link href="{{ secure_asset('dash/assets/css/styles.min.css')}}" rel="stylesheet" >

    <!-- Icons Css -->
    <link href="{{ secure_asset('dash/assets/css/icons.css')}}" rel="stylesheet" >

    <!-- Node Waves Css -->
    <link href="{{ secure_asset('dash/assets/libs/node-waves/waves.min.css')}}" rel="stylesheet" > 

    <!-- Simplebar Css -->
    <link href="{{ secure_asset('dash/assets/libs/simplebar/simplebar.min.css')}}" rel="stylesheet" >
    
    <!-- Color Picker Css -->
    <link rel="stylesheet" href="{{ secure_asset('dash/assets/libs/flatpickr/flatpickr.min.css')}}">
    <link rel="stylesheet" href="{{ secure_asset('dash/assets/libs/@simonwep/pickr/themes/nano.min.css')}}">

    <!-- Choices Css -->
    <link rel="stylesheet" href="{{ secure_asset('dash/assets/libs/choices.js/public/assets/styles/choices.min.css')}}">


<link rel="stylesheet" href="{{ secure_asset('dash/assets/libs/jsvectormap/css/jsvectormap.min.css')}}">

<link rel="stylesheet" href="{{ secure_asset('dash/assets/libs/swiper/swiper-bundle.min.css')}}">
...
<body>
                ...
                <div class="header-content-right">
                    ...
                    <div class="header-element country-selector">
                        ...
                        <a href="javascript:void(0);" class="header-link dropdown-toggle" data-bs-auto-close="outside" data-bs-toggle="dropdown">
                            <img src="{{ secure_asset('dash/assets/images/flags/us_flag.jpg')}}" alt="img" class="rounded-circle">
                        </a>
                        ...
                        <ul class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                            <li>
                                <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                                    <span class="avatar avatar-xs lh-1 me-2">
                                        <img src="{{ secure_asset('dash/assets/images/flags/us_flag.jpg')}}" alt="img">
                                    </span>
                                    English
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                                    <span class="avatar avatar-xs lh-1 me-2">
                                        <img src="{{ secure_asset('dash/assets/images/flags/spain_flag.jpg')}}" alt="img" >
                                    </span>
                                    Spanish
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                                    <span class="avatar avatar-xs lh-1 me-2">
                                        <img src="{{ secure_asset('dash/assets/images/flags/french_flag.jpg')}}" alt="img" >
                                    </span>
                                    French
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                                    <span class="avatar avatar-xs lh-1 me-2">
                                        <img src="{{ secure_asset('dash/assets/images/flags/germany_flag.jpg')}}" alt="img" >
                                    </span>
                                    German
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                                    <span class="avatar avatar-xs lh-1 me-2">
                                        <img src="{{ secure_asset('dash/assets/images/flags/italy_flag.jpg')}}" alt="img" >
                                    </span>
                                    Italian
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                                    <span class="avatar avatar-xs lh-1 me-2">
                                        <img src="{{ secure_asset('dash/assets/images/flags/russia_flag.jpg')}}" alt="img" >
                                    </span>
                                    Russian
                                </a>
                            </li>
                            ...
                            <ul class="list-unstyled mb-0" id="header-cart-items-scroll">
                                <li class="dropdown-item">
                                    <div class="d-flex align-items-start cart-dropdown-item">
                                        <img src="{{ secure_asset('dash/assets/images/ecommerce/jpg/1.jpg')}}" alt="img" class="avatar avatar-sm avatar-rounded br-5 me-3">
                                ...
                                <li class="dropdown-item">
                                    <div class="d-flex align-items-start cart-dropdown-item">
                                        <img src="{{ secure_asset('dash/assets/images/ecommerce/jpg/3.jpg')}}" alt="img" class="avatar avatar-sm avatar-rounded br-5 me-3">
                                        <div class="flex-grow-1">
                                            <div class="d-flex align-items-start justify-content-between mb-0">
                                                <div class="mb-0 fs-13 text-dark fw-semibold">
                                ...
                                <li class="dropdown-item">
                                    <div class="d-flex align-items-start cart-dropdown-item">
                                        <img src="{{ secure_asset('dash/assets/images/ecommerce/jpg/5.jpg')}}" alt="img" class="avatar avatar-sm avatar-rounded br-5 me-3">
                                        <div class="flex-grow-1">
                                            <div class="d-flex align-items-start justify-content-between mb-0">
                                                <div class="mb-0 fs-13 text-dark fw-semibold">
                                ...
                                <li class="dropdown-item">
                                    <div class="d-flex align-items-start cart-dropdown-item">
                                        <img src="{{ secure_asset('dash/assets/images/ecommerce/jpg/4.jpg')}}" alt="img" class="avatar avatar-sm avatar-rounded br-5 me-3">
                                        <div class="flex-grow-1">
                                            <div class="d-flex align-items-start justify-content-between mb-0">
                                                <div class="mb-0 fs-13 text-dark fw-semibold">
                                ...
                                <li class="dropdown-item">
                                    <div class="d-flex align-items-start cart-dropdown-item">
                                        <img src="{{ secure_asset('dash/assets/images/ecommerce/jpg/6.jpg')}}" alt="img" class="avatar avatar-sm avatar-rounded br-5 me-3">
                                        <div class="flex-grow-1">
                                            <div class="d-flex align-items-start justify-content-between mb-0">
                                                <div class="mb-0 fs-13 text-dark fw-semibold">
                               ...
                               <div class="row g-2">
                                       ...
                                       <a href="javascript:void(0);">
                                            <div class="text-center p-3 related-app">
                                                <span class="avatar avatar-sm avatar-rounded">
                                                    <img src="{{ secure_asset('dash/assets/images/apps/figma.png')}}" alt="">
                                                </span>
                                   ...
                                   <div class="col-4">
                                        <a href="javascript:void(0);">
                                            <div class="text-center p-3 related-app">
                                                <span class="avatar avatar-sm avatar-rounded">
                                                    <img src="{{ secure_asset('dash/assets/images/apps/microsoft-powerpoint.png')}}" alt="">
                                                </span>
                                   ...
                                   <div class="col-4">
                                        <a href="javascript:void(0);">
                                            <div class="text-center p-3 related-app">
                                                <span class="avatar avatar-sm avatar-rounded">
                                                    <img src="{{ secure_asset('dash/assets/images/apps/microsoft-word.png')}}" alt="">
                                                </span>
                                   ...
                                   <div class="col-4">
                                        <a href="javascript:void(0);">
                                            <div class="text-center p-3 related-app">
                                                <span class="avatar avatar-sm avatar-rounded">
                                                    <img src="{{ secure_asset('dash/assets/images/apps/calender.png')}}" alt="">
                                                </span>
                                   ...
                                   <div class="col-4">
                                        <a href="javascript:void(0);">
                                            <div class="text-center p-3 related-app">
                                                <span class="avatar avatar-sm avatar-rounded">
                                                    <img src="{{ secure_asset('dash/assets/images/apps/sketch.png')}}" alt="">
                                                </span>
                                   ...
                                   <div class="col-4">
                                        <a href="javascript:void(0);">
                                            <div class="text-center p-3 related-app">
                                                <span class="avatar avatar-sm avatar-rounded">
                                                    <img src="{{ secure_asset('dash/assets/images/apps/google-docs.png')}}" alt="">
                                                </span>
                                   ...
                                   <div class="col-4">
                                        <a href="javascript:void(0);">
                                            <div class="text-center p-3 related-app">
                                                <span class="avatar avatar-sm avatar-rounded">
                                                    <img src="{{ secure_asset('dash/assets/images/apps/google.png')}}" alt="">
                                                </span>
                                   ...
                                   <div class="col-4">
                                        <a href="javascript:void(0);">
                                            <div class="text-center p-3 related-app">
                                                <span class="avatar avatar-sm avatar-rounded">
                                                    <img src="{{ secure_asset('dash/assets/images/apps/translate.png')}}" alt="">
                                                </span>
                                   ...
                                   <div class="col-4">
                                        <a href="javascript:void(0);">
                                            <div class="text-center p-3 related-app">
                                                <span class="avatar avatar-sm avatar-rounded">
                                                    <img src="{{ secure_asset('dash/assets/images/apps/google-sheets.png')}}" alt="">
                                                </span>
                    ...
                    <div class="header-element">
                        ...
                        <a href="#" class="header-link dropdown-toggle" id="mainHeaderProfile" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                            <div class="d-flex align-items-center">
                                <div class="me-sm-2 me-0">
                                    <img src="{{ secure_asset('dash/assets/images/faces/9.jpg')}}" alt="img" width="32" height="32" class="rounded-circle">
                                </div>
                        ...
                        <!-- End::header-link|شdropdown-toggle -->
                                            ...
                                            <ul class="list-unstyled crm-top-deals mb-0">
                                                <li>
                                                    <div class="d-flex align-items-top flex-wrap">
                                                        <div class="me-2">
                                                            <span class="avatar avatar-sm avatar-rounded">
                                                                <img src="{{ secure_asset('dash/assets/images/faces/10.jpg')}}" alt="">
                                                            </span>
                                                        </div>
                                                        <div class="flex-fill">
                                                ...
                                                <li>
                                                    <div class="d-flex align-items-top flex-wrap">
                                                        <div class="me-2">
                                                            <span class="avatar avatar-sm avatar-rounded">
                                                                <img src="{{ secure_asset('dash/assets/images/faces/12.jpg')}}" alt="">
                                                            </span>
                                                        </div>
                                                        <div class="flex-fill">
                                                ...
                                                <tbody>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center fw-semibold">
                                                                <span class="avatar avatar-sm me-2 avatar-rounded">
                                                                    <img src="{{ secure_asset('dash/assets/images/faces/4.jpg')}}" alt="img">
                                                                </span>Mayor Kelly
                                                            </div>
                                                        </td>
                                                        <td>Manufacture</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center fw-semibold">
                                                                <span class="avatar avatar-sm me-2 avatar-rounded">
                                                                    <img src="{{ secure_asset('dash/assets/images/faces/15.jpg')}}" alt="img">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center fw-semibold">
                                                                <span class="avatar avatar-sm me-2 avatar-rounded">
                                                                    <img src="{{ secure_asset('dash/assets/images/faces/11.jpg')}}" alt="img">
                                                                </span>Simon Cowel
                                                            </div>
                                                        </td>
                                                        <td>Service</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center fw-semibold">
                                                                <span class="avatar avatar-sm me-2 avatar-rounded">
                                                                    <img src="{{ secure_asset('dash/assets/images/faces/8.jpg')}}" alt="img">
                                                                </span>Mirinda Hers
                                                            </div>
                                                        </td>
                                                        <td>Marketing</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center fw-semibold">
                                                                <span class="avatar avatar-sm me-2 avatar-rounded">
                                                                    <img src="{{ secure_asset('dash/assets/images/faces/9.jpg')}}" alt="img">
                                                                </span>Jacob Smith
                                                            </div>
                                                        </td>
    ...
    <!-- Popper JS -->
    <script src="{{ secure_asset('dash/assets/libs/@popperjs/core/umd/popper.min.js')}}"></script>

    <!-- Bootstrap JS -->
    <script src="{{ secure_asset('dash/assets/libs/bootstrap/js/bootstrap.bundle.min.js')}}"></script>

    <!-- Defaultmenu JS -->
    <script src="{{ secure_asset('dash/assets/js/defaultmenu.min.js')}}"></script>

    <!-- Node Waves JS-->
    <script src="{{ secure_asset('dash/assets/libs/node-waves/waves.min.js')}}"></script>

    <!-- Sticky JS -->
    <script src="{{ secure_asset('dash/assets/js/sticky.js')}}"></script>

    <!-- Simplebar JS -->
    <script src="{{ secure_asset('dash/assets/libs/simplebar/simplebar.min.js')}}"></script>
    <script src="{{ secure_asset('dash/assets/js/simplebar.js')}}"></script>

    <!-- Color Picker JS -->
    <script src="{{ secure_asset('dash/assets/libs/@simonwep/pickr/pickr.es5.min.js')}}"></script>


    <!-- JSVector Maps JS -->
    <script src="{{ secure_asset('dash/assets/libs/jsvectormap/js/jsvectormap.min.js')}}"></script>

    <!-- JSVector Maps MapsJS -->
    <script src="{{ secure_asset('dash/assets/libs/jsvectormap/maps/world-merc.js')}}"></script>

    <!-- Apex Charts JS -->
    <script src="{{ secure_asset('dash/assets/libs/apexcharts/apexcharts.min.js')}}"></script>

    <!-- Chartjs Chart JS -->
    <script src="{{ secure_asset('dash/assets/libs/chart.js/chart.min.js')}}"></script>

    <!-- CRM-Dashboard -->
    <script src="{{ secure_asset('dash/assets/js/crm-dashboard.js')}}"></script>

    
    <!-- Custom-Switcher JS -->
    <script src="{{ secure_asset('dash/assets/js/custom-switcher.min.js')}}"></script>

    <!-- Custom JS -->
    <script src="{{ secure_asset('dash/assets/js/custom.js')}}"></script>
